        ...
        .then(response => {
            ...
            return fetch(weathInfo)
                ...
                .then(res => {
                    ...
                    newObj.icon = c.icon;
                    newObj.datetime = new Date(c.time * 1000).toLocaleString(
                        'en-us',
                        options
                    );
                    ...
                    newObj.sunrise = new Date(d[0].sunriseTime * 1000).toLocaleTimeString(
                        'en-US',
                        sunOpts
                    );
                    newObj.sunset = new Date(d[0].sunsetTime * 1000).toLocaleTimeString(
                        'en-US',
                        sunOpts
                    );
